...
const experienceGroups = [
  ...
  [
    {
      year: 'February 2024 - January 2025',
...
const Experience = () => {
  return (
    <div className='mb-16'>
      <h2 id='experience' className='text-3xl mb-6'>
        Past Experiences
      </h2>
      {experienceGroups.map((experienceList, groupIndex) => (
        <div key={groupIndex} className='mb-10'>
              ...
              >
                ...
                <p>
                  ...
                  {exp.description.includes(',') &&
                    exp.description.substring(exp.description.indexOf(','))}
                </p>
          ...
          {groupIndex < experienceGroups.length - 1 && (
            <hr className='border-dotted border-t border-white-800 mt-8 mb-8' />
          )}
        </div>
      ))}
    </div>
