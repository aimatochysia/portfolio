    ...
    <div className="mb-16">
      ...
      <ul className="space-y-4">
        {publications.map((pub, index) => (
          <li key={index} className="px-4 py-2 bg-[#000000] backdrop-blur-lg border border-white/80 rounded-lg shadow-lg glassmorphism transform hover:scale-105 transition-transform duration-300">
